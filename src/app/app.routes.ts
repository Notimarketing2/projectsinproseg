...
export const routes: Routes = [
    ...
    { path: 'Pacífica', component: PacificoComponent},
    { path: 'Andina', component: AndinaComponent},
    { path: 'Oriniquía', component: OrinoquiaComponent},
    { path: 'Amazonía', component: AmazoniaComponent},
    { path: 'coopserpar', component: CoopserparComponent},
    { path: 'haz-parte', component: HazParteComponent},
];
